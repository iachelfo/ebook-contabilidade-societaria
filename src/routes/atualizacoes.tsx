...
function Atualizacoes() {
  return (
    <section>
      ...
      <p className="lead">
        Changelog da versão 1.1 (10/09/2026). O texto dos quinze capítulos permanece o de
        08/09/2026, salvo a correção da decomposição 8,8%/17,7% no capítulo 10 e as
        reescritas pontuais dos capítulos 3, 9 e 11 nesta data. Cada item abaixo traz
        fonte, capítulo e a razão da inclusão. A regra do próprio eBook - nenhuma
        afirmação normativa sem conferência na fonte oficial - é a que autoriza a addenda.
      </p>
      {ADDENDA.map((item) => (
